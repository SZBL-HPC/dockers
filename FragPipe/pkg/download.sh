...
while IFS= read -r url || [[ -n "${url}" ]]; do
    ...
    case "${file_name}" in
        FragPipe-24.0-linux.zip)
            expected_sha1="535477cb0e0890c37f0571f05d150eafb2c902b4"
            ;;
        IonQuant-1.11.20.zip)
            expected_sha1="fc78b5be42dc0ee192f0949c0eabf590b05c9241"
            ;;
        MSFragger-4.4.1.zip)
            expected_sha1="d69c12476faeb26607f832179bbce307b687b53e"
            ;;
        diatracer-2.2.1.zip)
            expected_sha1="334dc77b5ab2acf9d46dc97c39be653b7088b8ee"
            ;;
        *)
            printf 'error: no embedded SHA-1 for URL: %s\n' "${url}" >&2
            exit 1
            ;;
    esac
